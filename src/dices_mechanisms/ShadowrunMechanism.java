 ...
 * @author Nicolas Brax
 */
public class ShadowrunMechanism implements GameMechanism {
   ...
   * other than 'D' are meant to be replaced by digits.
  ...
  public String mechanismQuickDescription(){
    return "In Shadowrun, six faces dices are launched and the results are "
            ...
            + "as a hit and is taken into account to reach the threshold. "
            + "Moreover effects might happen: \r\n"
