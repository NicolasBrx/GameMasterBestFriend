...
/**
 * This class is designed to represent the exception specific to the character
 ...
 * @author Nicolas Brax
 */
public class RPG_CharacterManagementException extends Exception {
  /****************************************************************************/
  /** Constructor Methods                                                    **/
  /****************************************************************************/
   ...
   */
  public RPG_CharacterManagementException(String message) {
    super("Error on Character Management: " + message);
  }
   ...
   */
  public RPG_CharacterManagementException(String message, Throwable throwable) {
    super("Error on Character Management: " + message, throwable);
  }
}
