...
/**
 * This class is designed to represent the exception specific to the dice
 * launcher module of the project.
 * 
 ...
 * @author Nicolas Brax
 */
public class RPG_DiceException extends Exception {
  /****************************************************************************/
  /** Constructor Methods                                                    **/
  /****************************************************************************/
   ...
   */
  public RPG_DiceException(String message) {
   ...
   */
  public RPG_DiceException(String message, Throwable throwable) {
