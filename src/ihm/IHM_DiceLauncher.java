...
import dices_mechanisms.AddMechanism;
import dices_mechanisms.CthulhuMechanism;
import dices_mechanisms.FengShuiMechanism;
import java.net.URL;
import javax.swing.ImageIcon;
import dices_mechanisms.GameMechanism;
import dices_mechanisms.OresteMechanism;
import dices_mechanisms.PatientMechanism;
import dices_mechanisms.ShadowrunMechanism;
import dices_mechanisms.TombeauMechanism;
import dices_mechanisms.GenericMechanism;
 ...
 * @author nicolas
 */
public class IHM_DiceLauncher extends javax.swing.JFrame {
  ...
  public void setGame(Games game){
    ...
    switch(this.game){
      case ADD:
        this.mechanisms = new AddMechanism();
        break;
      case SR:
        this.mechanisms = new ShadowrunMechanism();
        break;
      case CTHULHU:
        this.mechanisms = new CthulhuMechanism();
        break;
      case P13:
        this.mechanisms = new PatientMechanism();
        break;
      case FS:
        this.mechanisms = new FengShuiMechanism();
        break;
      case ORESTE:
        this.mechanisms = new OresteMechanism();
        break;
      case TOMBEAU:
        this.mechanisms = new TombeauMechanism();
        break;
      default:
        this.mechanisms = new GenericMechanism();
        break;
    }
  }
  ...
  private void jbtnLaunchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnLaunchActionPerformed
    ...
    catch(RPG_DiceException e){
      try{
        GameMechanism backup = new GenericMechanism();                          // test if the user want to launch
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(IHM_DiceLauncher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new IHM_DiceLauncher().setVisible(true);
      }
    });
  }
