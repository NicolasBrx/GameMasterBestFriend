 ...
 * @author Nicolas Brax
 */
public class IHM_GameChooser extends javax.swing.JFrame {
  
  private Games choosenGame;
  ...
  */  
  ...
  private void jbtnChooseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnChooseActionPerformed
    ...
    this.choosenGame = Games.valueOf(tmp.get(1));
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(IHM_GameChooser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new IHM_GameChooser().setVisible(true);
      }
    });
  }
