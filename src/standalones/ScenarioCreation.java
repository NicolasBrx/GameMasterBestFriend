...
public class ScenarioCreation {
   ...
   * 
   */
  public static IHM_ScenarioCreation ihm;
  
  /**
   * @param args the command line arguments
   * @throws exceptions.RPG_ScenarioManagementException
   */
  public static void main(String[] args) throws RPG_ScenarioManagementException {
    try {
      ...
      throw new RPG_ScenarioManagementException("Can't set the UI Look and Feel.");
    }
    ihm = new IHM_ScenarioCreation();
    ihm.setVisible(true);
   ...
   * @return 
   */
  public IHM_ScenarioCreation getMainFrame(){
    return ihm;
  }
